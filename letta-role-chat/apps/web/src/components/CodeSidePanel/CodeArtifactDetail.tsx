...
export default function CodeArtifactDetail({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* 详情头部 */}
      <div className="shrink-0 px-3 py-2.5 flex items-center gap-3 border-b border-slate-800/50 bg-slate-900/50">
        <button
          type="button"
          onClick={onBack}
      ...
      <div className="flex-1 overflow-auto">
        {artifact.code ? (
          ...
          <div className="p-4 text-slate-500 text-center">无内容</div>
        )}
      </div>
    </div>
  );
